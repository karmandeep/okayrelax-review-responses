...
//Listing page
$_ADDONLANG['review_title'] = "Task";
$_ADDONLANG['review_admin'] = "VA";
$_ADDONLANG['review_message'] = "Response";
$_ADDONLANG['review_status'] = "Status";
$_ADDONLANG['review_customer'] = "Customer";
...
$_ADDONLANG['review_heading'] = "Review";
$_ADDONLANG['review_msgs'] = "Messages";
$_ADDONLANG['review_msg'] = "Send Message";

$_ADDONLANG['unpublished'] = "Un-Published";
$_ADDONLANG['underreview'] = "Under-Review";
$_ADDONLANG['published'] = "Published";
$_ADDONLANG['accepted'] = "Accepted";
$_ADDONLANG['rejected'] = "Rejected";

$_ADDONLANG['dateadded'] = "Date Added";
$_ADDONLANG['datemodified'] = "Date Last Modified";

$_ADDONLANG['review_reason'] = "Reason";
$_ADDONLANG['no_review_msgs'] = 'No Review messages yet!';

$_ADDONLANG['task_status_change'] = 'Task Status Change';
